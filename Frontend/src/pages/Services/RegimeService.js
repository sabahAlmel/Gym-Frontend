...
const RegimeServices = () =>{
    return(
        <div className={style.container}>
            <h3 className={style.topic}>Every Meals Counts: A Complete Body-Type Nutrition Guide!</h3>
            ...
            <div className={style.texts}>
              <p className={style.text}>You'll receive one-on-one guidance from certified trainers who will create and adjust your plan to maximize your results</p>
              <p className={style.text}> Your journey is ongoing, and so is our support. We're here to help you overcome plateaus and achieve your goals.</p>
              <p className={style.text}>Our clients have achieved remarkable results, and you can see their transformations in our success stories.</p>
            </div>
            </div>
        </div>
    )
