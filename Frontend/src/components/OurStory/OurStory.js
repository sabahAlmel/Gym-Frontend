    ...
    <>
      <div className={styles.container}>
        ...
        <p className={styles.content}>
          ...
          as a family-owned business dedicated to providing exceptional gym
          equipment at affordable prices. But, we dreamed bigger than just being
          an ordinary fitness equipment supplier, we aspired to lead the
          industry.
        </p>
      </div>
