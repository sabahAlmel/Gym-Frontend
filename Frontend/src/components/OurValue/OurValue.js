    ...
    <>
      <div className={style.valueSection}>
        <div className={style.ourValue}>
          <h2 className={style.valueTitle}>our value</h2>
        ...
        <div className={style.valueVariants}>
          <div className={style.valueVariant}>
            <img
              className={style.variantImage}
              src={variantOne}
              alt="Powered"
            />
            <h2 className={style.variantTitle}>powered by you</h2>
            <p className={style.variantDescription}>
              Fithub has reached tens of millions around the globe, all from
              word of mouth; happy viewers sharing our content with friends and
              family.
            </p>
          </div>
