...
import { ProductsUpdateModal } from "../../components/Product/ProductsModal/ProductsUpdateModal";
  ...
  const columns = [
    {
      ...
      renderCell: (params) => (
        <img
          src={`${process.env.REACT_APP_PATH}${params.row.prodImage}`}
          alt="Image"
          style={{ width: 50, height: 50, borderRadius: "50%" }}
        />
      ),
    },
    { field: "prodName", headerName: "Name", width: isDesktop ? 150 : 120 },
    {
      field: "prodPrice",
      headerName: "Price",
      width: 90,
